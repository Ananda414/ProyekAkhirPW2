    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <input type="text" id="filterInput" class="form-control mb-3" placeholder="Filter nama resep...">
                ...
                <div class="table-responsive">
                    <table class="table table-striped" id="resepTable">
                        <thead>
                            <tr>
                                <th>No.</th>
                                <th>Nama Resep</th>
                ...
                @if ($reseps instanceof \Illuminate\Pagination\AbstractPaginator)
                    <div class="pagination-wrapper">
                        {{ $reseps->appends(['per_page' => request('per_page')])->links('pagination::bootstrap-4') }}
                    </div>
                @endif

                <a href="{{ route('resep.downloadPDF') }}" class="btn btn-info">Download PDF</a>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#filterInput').on('keyup', function() {
            ...
            $('#resepTable tbody tr.main-row').each(function() {
