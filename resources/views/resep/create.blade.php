                ...
                <div class="col-12">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <p class="card-description"> Masukkan data berikut untuk tambah resep </p>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group row">
                              <label class="col-sm-3 col-form-label">Nama Resep</label>
                              <div class="col-sm-9">
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-sm-9">
                                ...
                                name="spesifikasi" placeholder="Jika tidak ada kosongkan saja">
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="form-group">
                          ...
                          <input value="{{'$resep->foto' }}" type="file" class="form-control" name="foto"
                          ...
                          <a href="{{ route('dashboard') }}" class="btn btn-light">Cancel</button></a>
                        </form>
                      </div>
                    </div>
                  </div>
