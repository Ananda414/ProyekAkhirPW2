...
@section('title', 'Halaman Komputer')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <input type="text" id="filterInput" class="form-control mb-3" placeholder="Filter nama komputer...">
                ...
                <div class="table-responsive">
                    <table class="table table-striped" id="komputerTable">
                        <thead>
                            <tr>
                                <th>No.</th>
                                <th>Nama Barang</th>
                                ...
                                <tr class="main-row">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="mr-2">
                                                @can('update', $item)
                                                <a href="{{ route('komputer.edit', $item->id)}}">
                ...
                @if ($komputers instanceof \Illuminate\Pagination\AbstractPaginator)
                    <div class="pagination-wrapper">
                        {{ $komputers->appends(['per_page' => request('per_page')])->links('pagination::bootstrap-4') }}
                    </div>
                @endif

                <a href="{{ route('komputer.downloadPDF') }}" class="btn btn-info">Download PDF</a>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#filterInput').on('keyup', function() {
            ...
            $('#komputerTable tbody tr.main-row').each(function() {
